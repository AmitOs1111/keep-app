// import { dataStayService } from '../../services/demoData/demo.data.js'
...
function query(entityType, filterBy = {}, delay = 600) {
  ...
  if (filterBy.place) {
    const regExp = new RegExp(filterBy.place, 'i')

    entities = entities.filter(
      (stay) => regExp.test(stay.loc.country) || regExp.test(stay.loc.city)
    )
  }
